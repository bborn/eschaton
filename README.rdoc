...
==== "A shocking spectacle of decadence" - <tt>Joe Marker</tt>
==== "very, very fast and very, very loud" - <tt>Penny Polygon</tt>
==== "a bombardment of the most unsubtle, one-dimensional noise" - <tt>Alan Artifact</tt>
==== "like listening to Al Green on Lp" - <tt>Paul Polyline</tt>
